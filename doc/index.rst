Sequana nanomerge pipeline documentation
#####################################################

|version|, |today|, status: production

The **nanomerge** pipeline is a `Sequana <https://github.com/sequana/sequana>`_ pipeline. You can find the source code 
on  `https://github.com/sequana/sequana_nanomerge <https://github.com/sequana/sequana_nanomerge/>`_. Would you have issues
...
The Sequana nanomerge pipeline
==============================================
